...
export default function ShoppingList({ liste, setListe, Nombre, setNombre, Total, setTotal,ouverture,setOuverture }) {
    const plantList = [{
        name: 'Monstera',
        category: 'classique',
        id: 1,
    ...
    return <div className='Boutique'>
        <form className='search'>
            <div>
                ...
                <input id='Categorie' placeholder='Categorie recherchee...' onChange={handleCategory} list='categorie' />
            ...
            <div>
                ...
                <input  placeholder='Nom recherche...' onChange={handleNom} list='nom' />
        ...
        <div className='cadre_plantes'>
            ...
            {plantList.filter((plante) => categorie !== "" ? plante.category.toLowerCase().includes(categorie.toLowerCase()) :
                plante.category !== undefined).filter((plante)=> plante.name.toLowerCase().includes(nom.toLowerCase())).map((plante) =>
                 <Plante props={[plante, Total, setTotal, Nombre, setNombre, liste, setListe, ouverture, setOuverture]} />) 
               }
